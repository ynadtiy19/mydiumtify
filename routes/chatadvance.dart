  ...
  if (context.request.method == HttpMethod.get) {
    ...
    if (params.containsKey('imgurl')) {
      ...
      var headers = {
        ...
        'PRIORITY': ' u=1, i',
        'SEC_CH_UA': ' "Chromium";v="134", "Not:A-Brand";v="24", "Microsoft Edge";v="134"',
        'SEC_CH_UA_MOBILE': ' ?0',
        'SEC_CH_UA_PLATFORM': ' "Windows"',
        'Content-Type': 'application/json'
      };
      var request = http.Request('POST', Uri.parse('https://chat.writingmate.ai/api/chat/public'));
      ...
      if (response.statusCode == 200) {
        ...
        String caption = responseJson['caption'];
      ...
      return Response.json(statusCode: 400, body: {'error': 'imgurl parameter is missing'});
    }
  } else {
